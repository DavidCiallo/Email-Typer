...
export type StrategyDTO = Pick<StrategyEntity, "id" | "name" | "from_pattern" | "to_pattern" | "subject_pattern" | "forward_to" | "enabled" | "account_id" | "scope" | "grant_id"> & { creator_name?: string; creator_email?: string };
